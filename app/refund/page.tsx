...
export const metadata: Metadata = { title:"Refund Policy", description:"Refund Policy of Fikr Fardan Foundation" };

export default function RefundPage() {
  return (
    <>
      <Navbar />
      <PageHero badge="Legal" title="Refund" highlight="Policy" subtitle={`Fikr Fardan Foundation — ${BRAND.address}`} />
      <section style={{ background:"#F8F6FB", padding:"5.5rem 1.5rem" }}>
        <div style={{ maxWidth:860, margin:"0 auto", background:"white", borderRadius:24, padding:"3rem", border:"1px solid rgba(107,45,143,.08)" }}>
          {[
            ["General Policy", "Donations made to Fikr Fardan Foundation are generally non-refundable, as funds are immediately allocated to active projects and beneficiaries."],
