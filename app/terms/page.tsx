...
export const metadata: Metadata = { title:"Terms of Use", description:"Terms and conditions of Fikr Fardan Foundation" };
      ...
      <section style={{ background:"#F8F6FB", padding:"5.5rem 1.5rem" }}>
        <div style={{ maxWidth:860, margin:"0 auto", background:"white", borderRadius:24, padding:"3rem", border:"1px solid rgba(107,45,143,.08)" }}>
          <Section title="1. Acceptance">
            <p>By using the Fikr Fardan Foundation website, you agree to these Terms of Use. If you disagree, please do not use our services.</p>
          </Section>
          ...
          <Section title="3. Donations">
            <p>All donations are voluntary contributions. Fikr Fardan Foundation commits to using donations for stated purposes. Donations are non-refundable except under our Refund Policy. We reserve the right to redirect unused funds to similar causes.</p>
          </Section>
          ...
          <Section title="5. Intellectual Property">
            <p>All content on this website — including logos, course materials, videos, and text — belongs to Fikr Fardan Foundation. Unauthorized reproduction is prohibited.</p>
          </Section>
          <Section title="6. Limitation of Liability">
            <p>Fikr Fardan Foundation is not liable for any indirect or consequential damages arising from use of our services. Our total liability shall not exceed the amount donated in the past 30 days.</p>
          </Section>
